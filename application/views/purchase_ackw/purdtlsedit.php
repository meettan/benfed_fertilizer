    ...
    <div class="col-md-8 container form-wraper">
        ...
        <form method="POST" action="<?php echo site_url("stock/purackdtladd") ?>" onsubmit="return valid_data()"
            ...
            <div class="form-header">
                ...
                <h4>View Of Acknowledgement Details </h4>
            ...
            <div class="form-group row">
                ...
                <input type="text" id=prod_id name="prod_id" class="form-control"
...
<label for="soc_id" class="col-sm-2 col-form-label">Type:</label>
	...
	value="<?php echo $mempDtls->del_dt; ?>" required readonly/>
            ...
            <?php 
             ...
             foreach($purdtls as $memdt) { 
               
               ?>
                     
            <tr>
                <td>
                    <select name="soc_id[]" style="width:350px" class="form-control soc_id" disabled id="soc_id"   required>

          <option value="">Select Type</option>
              
            <?php
           
             foreach($mempDts as $key5)
            
            { ?>

                <option value="<?php echo $memdt->soc_id;?>"
                <?php 
                 
                if( ($memdt->prod_id==$key5->prod_id) && ($memdt->memo_no==$key5->memo_no) ) echo "selected" ?>>
                <?php echo $memdt->soc_name; ?></option>
            <?php } ?>
            </select>
            </td>
                                  <!-- <td>
                                ...
                                <td>
                                    <input type="text" name="qty[]" id="qty" style="width:130px;" class="form-control qty" disabled value="<?php  echo $memdt->qty; ?>"
                                        id="qty">
                                    <?php
                                        $sum = 0;
                                        foreach($purdtls as $memdt) {
