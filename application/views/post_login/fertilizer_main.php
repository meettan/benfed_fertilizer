                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <div class="sub-dropdown">     
                              ...
                              <a href="<?php echo site_url("stock/shortage_entry");?>">Shortage Damage</a>
                              <a href="<?php echo site_url("stock/purackw");?>">Material acknowledge</a>
                            ...
                            <div class="dropdown-content">
							   <?php if( $this->session->userdata['loggedin']['ho_flag']!="Y"){?>
                                ...
                                <div class="sub-dropdown">
                                   ...
                                   <a href="<?php echo site_url("fert/rep/company_advpayment");?>">Company Adv Payment New(Matix)</a>
                               ...
                               <div class="sub-dropdown">
								   ...
								   <div class="sub-dropdown-content">
									   ...
									   <a href="<?php echo site_url("fert/rep/gstrepb2c");?>">GST INOUT Report B2C</a>
										<a href="<?php echo site_url("fert/rep/hsnsumryrep");?>">B2B Sale GST HSN Summary</a>
                                        <a href="<?php echo site_url("fert/rep/hsnsumryrepb2c");?>">B2C Sale GST HSN Summary</a>
