...
<div class="wraper">
    ...
    <div class="col-md-10 container form-wraper">
        ...
        <form method="POST" action="<?php echo site_url("drcrnote/dr_noteadj_bradd") ?>" onsubmit="return valid_data()"
            id="form">
            <!-- <form method="POST" action="<?php echo site_url("socpay/society_payAdd") ?>"onsubmit="myFunction()" id="form"> -->

            <div class="form-header">

                <h4>Debit Note Adjustment</h4>
            ...
            <div class="form-group row">
                <label for="trans_do" class="col-sm-2 col-form-label">Receipt No:</label>
                <div class="col-sm-3">
                ...
                <label for="do_dt" class="col-sm-2 col-form-label">Receipt Date:</label>
                <div class="col-sm-3">
    ...
    $(document).ready(function () {
        ...
        $('#trans_do').change(function () {
            ...
            $.get(
                    ...
                    '<?php echo site_url("drcrnote/f_get_drnote_rcptdtl");?>', {
    ...
    $(document).ready(function () {
        ...
        $('#soc_id').change(function () {
            ...
            $.get(
                ...
                '<?php echo site_url("drcrnote/f_get_drnoterecpt");?>',
