	...
	<div class="wrapper">
		<div class="col-sm-12 float-left portfolioRight"><?= strlen($this->session->flashdata('msg')) > 0 ? $this->session->flashdata('msg') : ''; ?>
            <!-- <div class="card-header">Oders</div> -->
                <div class="row">
                    <?= form_open('fertilizer/upload_csv/upload_reconcile', $attributes); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" width="10" class="form-control fileBrowse" name="upload_file" id="userfile" accept=".csv" onchange="triggerValidation(this)">
                                    </div>
                                ...
                                <div class="mt-2 ml-3 mb-2">
                                        <span style="color:red">**Change the format of Sale Amount filed to number and save the file in .csv format.</span>
                                    </div>
