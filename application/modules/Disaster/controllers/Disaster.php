<?php
    ...
    // ***************************** For DM/ Transaction / Distribution Tab **************************** //
        ...
        public function editAgentDistribution()
        {
            ...
            $edit_dtls['data'] = $this->Disaster_m->f_get_agentDist_editData($order_no, $point_no, $sl_no);
        ...
        public function updateAgentDistribution()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=="POST")
            {
                ...
                $this->Disaster_m->updateAgentDistribution($sl_no, $dist_dt, $dist_cd, $sdo_memo, $bdo_memo, $point_no, $allot_qty, $modified_by, $modified_dt );
    ...
    // ***************************** For DM/ Transaction / Agent Delivery Tab **************************** //
        ...
        public function entryAgentDelivery()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=="POST")
            {
                ...
                $this->Disaster_m->insertAgentDelivery($sl_no, $trans_id, $del_dt, $dist_cd, $order_no, $point_no, $sdo_memo, $bdo_memo, $bill_no, $tot_qty, $challan_from, $challan_to, $rate, $amount, $remarks, $created_by, $created_dt );
        ...
        public function editdeliveryEntry()
        {
            ...
            $editData['data1'] = $this->Disaster_m->get_deliveryEdit_dtls($sl_no, $del_dt);
            $getBillNo = $this->Disaster_m->get_deliveryEdit_billNo($sl_no, $del_dt);
            //echo ($getBillNo->bill_no); die; 
            $editData['data3'] = $this->Disaster_m->get_challanEdit_dtls($del_dt, $getBillNo->bill_no);
            //echo "<pre>";
            //var_dump($editData['data2']); die;
        ...
        public function updateAgentDelivery()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=="POST")
            {
                ...
                $this->Disaster_m->updateAgentDelivery($sl_no, $trans_id, $del_dt, $dist_cd, $order_no, $point_no, $sdo_memo, $bdo_memo, $bill_no, $challan_from, $challan_to, $rate, $tot_qty, $amount, $modified_by, $modified_dt );
        ...
        public function confirmation()
        {
            ...
            $entryData['dist_data'] = $this->Disaster_m->f_get_districtCode();
            $this->load->view('confirmation/selection', $entryData);
    ...
    // **************************************************** //
        ...
        public function paymentEntry()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=="POST")
            {
                ...
                //echo $trans_dt; die;
                $transCd = $this->Disaster_m->f_get_payment_transId($trans_dt);
                ...
                $bill_no        =       $_POST['bill_no'];
                $part           =       $_POST['part'];
                $amount         =       $_POST['tot_amount'];
                $bank           =       $_POST['bank'];
                $trans_mode     =       $_POST['mode'];
                $ref_no         =       $_POST['ref_no'];
                $payment_dt     =       $_POST['payment_dt'];
                $remarks       =       $_POST['remarks'];

                $this->Disaster_m->paymentEntry($trans_dt, $trans_id, $dist_cd, $order_no, $sdo_memo, $bill_no, $part, $amount, $bank, $trans_mode, $ref_no, $payment_dt, $remarks, $created_by, $created_dt );
        ...
        public function delete_billPay($trans_dt, $trans_id, $bill_no)
        {

            $this->Disaster_m->f_delete_billPay($trans_dt, $trans_id, $bill_no);
            $this->billPay_record();
