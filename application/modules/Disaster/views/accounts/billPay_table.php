...
<div class="wraper">      
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-sm-12">
            ...
            <h1><strong>Bill Collection</strong></h1>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="<?php echo site_url('Disaster/delete_billPay/'.$key->trans_dt.'/'.$key->trans_id.'/'.$key->bill_no.' '); ?>" onclick="return confirm('Are you sure you want to delete this item?');" ><i class="fa fa-trash fa-fw fa-2x"></i></a></td>
