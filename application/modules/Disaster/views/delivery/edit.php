...
<!--  -->
    <form role="form" name="agent_delForm" method="POST" id="form" action="<?php echo site_url("Disaster/updateAgentDelivery");?>" onsubmit="return validate()" >
        ...
        { ?>
                    <input type="hidden" name="sl_no" value= "<?php echo $key1->sl_no; ?>" class="form-control required" id="sl_no" />
                    <input type="hidden" name="trans_id" class="form-control required" value= "<?php echo $key1->trans_id; ?> id="trans_id" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="date" name="del_dt" value= "<?php echo $key1->del_dt; ?>" class="form-control required" id="del_dt" readonly />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <select class="form-control" name="point_no" id="point_no" readonly >
                                ...
                                <option value="<?php echo ($key1->point_no); ?>"><?php echo ($key1->agent). '- '.($key1->sdo); ?></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="bill_no" class="form-control required" id="bill_no" value= "<?php echo $key1->bill_no; ?>" readonly />
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody id= "intro">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="challan_no[]" value= "<?php //echo $key3->challan_no; ?>" class="form-control required" id="challan_no" readonly />
                                        
                                    </td>
                                    
                                    <td>
                                        
                                        <input type="text" name="truck[]" value= "<?php //echo $key3->truck; ?>" class="form-control required" id="truck" />
                                        
                                    </td>

                                    <td>

                                        <input type="text" name="qty[]" value= "<?php //echo $key3->qty; ?>" class="form-control amount_cls" id="qty" />
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="1">
                                    <input name="tot_qty" id="tot_qty" class="form-control" value= "<?php //echo $key1->tot_qty; ?>" placeholder="MT." readonly>  
                                </td>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="amount" class="form-control required" id="amount" value= "<?php echo $key1->amount; ?>"  required readonly/>
