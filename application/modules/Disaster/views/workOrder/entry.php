    ...
    <div class="col-md-7 container form-wraper">
        ...
        <form method="POST" id="form" action="<?php echo site_url("Disaster/entryNewOrder");?>" >
            ...
            <!-- <div class="form-group row">
                ...
                <label for="item" class="col-sm-2 col-form-label">Item:<font color="red">*</font></label>

                <div class="col-sm-4">

                    <select type="text" name="item" class="form-control required" id="item" >
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" value= "" id= "unit" class= "form-control required" readonly>  
