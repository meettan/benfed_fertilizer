                    ...
                    ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="sdo" value="<?php echo ($key->sdo); ?>" class="form-control " id="sdo" readonly/>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" name="bdo" value="<?php echo ($key->bdo); ?>" class="form-control " id="bdo" readonly/>
