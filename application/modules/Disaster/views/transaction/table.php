                ...
                ?>
                    <tr>
                     ...
                     <!--   <td><?php //echo $key->sdo_memo.'<br>'.$key->bdo_memo; ?></td> -->
                        ...
                        <td><a href="<?php echo site_url('Disaster/editAgentDistribution?order_no='.$key->order_no.'&point_no='.$key->point_no.'&sl_no='.$key->sl_no.' '); ?>"><i class="fa fa-edit fa-fw fa-2x"></i></a></td>
