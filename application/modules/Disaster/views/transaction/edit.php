                ...
                <?php foreach($totalQty as $tot_key) { ?>                
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="tot_dist_qty_qnt" value= "<?php echo (@$tot_key->allot_qty_qnt); ?>" class="form-control required" id="tot_dist_qty_qnt" readonly />
                
                        </div>

                        <input type="hidden" name="sl_no" value= "<?php echo ($eData->sl_no); ?>" class="form-control required" /> 
                     -->
                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <select class="form-control" name="point_no" id="point_no" readonly >
                                                ...
                                                <option value= "<?php echo ($eData->point_no); ?>"><?php echo ($eData->agent).'- '.($eData->sdo) ; ?></option>                                              
                                        ...
                                        <td>
                                            ...
                                            <input name="allot_qty" id="allot_qty" value= "<?php echo ($eData->allot_qty); ?>" class="form-control amount_cls" placeholder="Amount" required>
