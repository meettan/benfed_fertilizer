 ...
 //For Cheque Details uploadation
  ...
  $paddycollection['paddycollection_dtls'] = $this->Paddy->f_get_collection_dwn($kms_id,$bnk_id,$trans_type);
    ...
    public function f_paddy_procurement_Excel(){
      ...
      $trans_type = $this->Paddy->get_transaction_type($soc_id,$trans_dt,$bulk_trans_id);
    ...
    public function f_delivered(){
        ...
        $data["receved"] = $this->Paddy->f_get_particulars("td_received", array("ifnull(sum(paddy_qty), 0) sum","MIN(trans_dt) as trans_dt"), $where, 1);
    ...
    public function f_totisseued(){
        ...
        $select     =   array(
            ...
            "ifnull(cp, 0) cp", 
            "ifnull(fci, 0) fci",
            "ifnull(tot_doisseued, 0) tot","rice_type",
            "dist","goodown_name"
        );
    ...
    public function f_wqsc_add() {
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            $data_array = array(           
                ...
                "no_gunny"       =>  $this->input->post('no_gunny'),
              
                "quantity"       =>  $this->input->post('quantity'),

                "moisture_extra"   =>  $this->input->post('moisture_extra'),

                "moisture_ext_amt" =>  $this->input->post('moisture_ext_amt'),

                "avg_wt_empty_gunny" =>  $this->input->post('avg_wt_empty_gunny'),
    ...
    public function total_cmr_delivery(){
        ...
        $select     =   array(
            ...
            "ifnull(t.tot_doisseued, 0) tot","t.trans_dt","t.rice_type","r.rate"
