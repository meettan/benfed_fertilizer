                ...
                <tbody> 
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $wqsc_dtl->created_dt; ?></td>
                                <td>

                                <a href="wqsc_edit?trans_no=<?php echo $wqsc_dtl->id; ?>" data-toggle="tooltip" data-placement="bottom" class="btn btn-primary view">
                                <i class="fa fa-eye">View</i>
                                </a>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <button type="button" class="delete"
                                        id="<?php echo $wqsc_dtl->id; ?>"
