                          ...
                          <td><?php  if($padl_dtl->bank_id == 1){
                            ...
                            <td style="text-align: ;">
                                ...
                                <?php if($padl_dtl->certificate_3=="Y") {?>
                                    <a href="<?php echo base_url()?>index.php/paddys/transactions/f_paddy_procurement_Excel/<?=$padl_dtl->soc_id;?>/<?=$padl_dtl->trans_dt;?>/<?=$padl_dtl->bulk_trans_id;?>" target="_blank" title="Download" id="btn" class="download btn btn-success" ><i class="fa fa-file-text-o fa-lg" aria-hidden="true"></i></a>
