    ...
    <div class="col-md-6 container form-wraper" style="margin-left: 5px;">
        ...
        <form method="POST" 
            ...
            <div class="form-group row">
                ...
                <label for="tot_pdy_delivrd" class="col-sm-2 col-form-label">Received Date:</label>
    ...
    $(document).ready(function(){
        ...
        $('#mill_name').change(function(){
            ...
            .done(function(data){
                ...
                console.log(received,wr_order);

                $('#tot_pdy_delivrd').val(received-wr_order);
    ...
    $(document).ready(function(){
        ...
        $('#rice_type').change(function(){
            ...
            .done(function(data){
                ...
                $('#progressive_res_paddy').val((($('#tot_pdy_delivrd').val() * parseInt(data)) / 100));
        ...
        $('#milled').keyup(function(){
            ...
            .done(function(data){
                ...
                var resultant_cmr = (($('#milled').val() * parseInt(data)) / 100).toFixed('3');
	   ...
	   $('#cmr_offered_now').keyup(function(){
	    ...
	    .done(function(data){
	        ...
	        if(rum != "NULL"){
	            ...
	            $('#total_progressive_cmr_offered').val(sum + rum);
