            ...
            <form method="POST" 
               ...
               <div class="col-sm-4">
                   ...
                   <select name="rice_type" class="form-control required">
                        ...
                        <option value="Boiled Rice" <?php if(isset($rate_dtls->rice_type) && ($rate_dtls->rice_type=="Boiled Rice")){ echo "selected" ;} ?>>Boiled Rice</option>
                        <option value="Raw Rice" <?php if(isset($rate_dtls->rice_type) && ($rate_dtls->rice_type=="Raw Rice")){ echo "selected" ;} ?>>Raw Rice</option>
                     </select>
                    </div>
