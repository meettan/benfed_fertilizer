    <div class="wraper"> 
		...
		<div class="col-md-6 container form-wraper">
			...
			<form method="POST" action="<?php echo site_url("Fertilizer/companyAdd") ?>" onsubmit="return valid_data()">
				...
				<div class="form-header">
					...
					<div class="form-group row">
					<label for="short_name" class="col-sm-2 col-form-label">Abbreviated Name:</label>
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						...
						<input type="text" style="width:170px;" id=pan_no name="pan_no" class="form-control"  />

					</div>
					</div>
				<div class="form-group row">
					<label for="cin" class="col-sm-2 col-form-label">CIN No:</label>
					<div class="col-sm-4">
