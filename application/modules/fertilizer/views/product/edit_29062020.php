        ...
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" id="form" action="<?php echo site_url("fertilizer/editproduct");?>" >
                ...
                <div class="form-group row">
                    ...
                    <option value="1" <?php echo ($schdtls->prod_type == 1)? 'selected' : '';?>>Organic - Fertilizer</option>
                    <option value="2" <?php echo ($schdtls->prod_type == 2)? 'selected' : '';?>>Bio- Fertilizer</option>
                    <option value="3" <?php echo ($schdtls->prod_type == 3)? 'selected' : '';?>>Others</option>
                </select>  
                    </div>
