<div class="wraper">      
        ...
        <div class="col-lg-12 container contant-wraper">    
            ...
            <h3>
		        <small><a href="<?php echo site_url("fertilizer/productAdd");?>" class="btn btn-primary" style="width: 100px;">Add</a></small>
		    ...
		    ?>
                            ...
                            <tr>   
                                ...
                                <td><?php echo $value->prod_desc; ?></td>
			 	                <td><a href="editproduct/edit?prod_id=<?php echo $value->prod_id;?>" 
