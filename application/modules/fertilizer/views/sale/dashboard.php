<div class="wraper">      
        ...
        <div class="col-lg-12 container contant-wraper">    
            ...
            <h3>
		        <small><a href="<?php echo site_url("fertilizer/saleAdd");?>" class="btn btn-primary" style="width: 100px;">Add</a></small>
    ...
    $(document).ready( function (){
        ...
        $('.delete').click(function () {
            ...
            if(result) {
                ...
                window.location = "<?php echo site_url('Fertilizer/fertilizer/deletesale?trans_do="+id+"');?>";
