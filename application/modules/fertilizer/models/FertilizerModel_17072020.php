...
/*Select Data from a table*/		
		...
		public function js_get_stock_qty($ro)
		{
			...
			$sql = $this->db->query("SELECT a.stock_qty qty,a.prod_id ,b.gst_rt  FROM td_purchase a ,mm_product b WHERE a.prod_id=b.prod_id and  a.ro_no = '$ro'");
			return $sql->row();
		}
		...
		public function f_get_sales_dtls(){
			// $user_id    = $this->session->userdata('login')->user_id;
