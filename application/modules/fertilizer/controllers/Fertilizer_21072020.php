...
redirect('fertilizer/cr_note');
		...
		public function sale(){
		   ...
		   $bank['data']    = $this->FertilizerModel->f_get_sales_dtls();
		   $this->load->view("post_login/fertilizer_main");
...
///*********************************************** */
		...
		public function invoiceAdd(){
			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
					...
					$br_cd      = $this->input->post('branch_id');
...
// die();
				...
				rate","base_price","net_amt","retlr_margin","spl_rebt","add_adj_amt","less_adj_amt","cgst","sgst",
