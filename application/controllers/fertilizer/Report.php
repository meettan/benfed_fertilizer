...
/******** */
public function hsnsumryrepb2c(){
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $data['purchase']    =   $this->ReportModel->f_get_hsn_gstb2c($from_dt,$to_dt);
        ...
        $this->load->view('post_login/fertilizer_main');
        $this->load->view('report/hsnsumryb2c/gst_stmt',$data);
        $this->load->view('post_login/footer');

    }else{

        $this->load->view('post_login/fertilizer_main');
        $this->load->view('report/hsnsumryb2c/gst_stmt_ip');
        $this->load->view('post_login/footer');
    }
...
public function gstr3brep(){ 
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $this->load->view('post_login/fertilizer_main');
        $this->load->view('report/gstr_3b/gst_stmt',$data);
        $this->load->view('post_login/footer');

    }else{

        $this->load->view('post_login/fertilizer_main');
        $this->load->view('report/gstr_3b/gst_stmt_ip');
        $this->load->view('post_login/footer');
    }
...
/*****company advance payment new*** */
public function company_advpayment(){
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if($refereceNo==""||$refereceNo==null){
            ...
            $data['total_Voucher']=$this->ReportModel->totalAdvVoucher($comp_id,$frm_date,$to_date,$refereceNo);
            $data['advsumrydtls']=$this->ReportModel->getpayadvummary($comp_id, $frm_date, $to_date, $refereceNo);
            }
      ...
      $data['tDate']=$to_date;
       ...
       $this->load->view('post_login/fertilizer_main');
       $this->load->view('report/company_advpayment/advPay.php',$data);
       $this->load->view('post_login/footer');
    }else{
        ...
        $this->load->view('post_login/fertilizer_main');
        $this->load->view('report/company_advpayment/advPay_ip.php',$data);
        $this->load->view('post_login/footer');
    }
}
